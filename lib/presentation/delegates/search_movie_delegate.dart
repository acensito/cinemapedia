...
class SearchMovieDelegate extends SearchDelegate<Movie?> {
  ...
  void _onQueryChanged(String query) {
    ...
    isLoadingStream.add(true); //indicamos que estamos escribiendo una busqueda, para cambiar el icono
              ...
              child: Column(
                ...
                Row(
                  children: [
                    ...
                    SizedBox(width: 5),
                    Text(HumanFormat.number(movie.voteAverage), style: textStyles.bodyMedium!.copyWith(color: Colors.yellow.shade900),)
                  ],
                )
              ])),
